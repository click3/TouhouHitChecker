...
#define SOUND_EFFECT_COUNT 60
#define SOUND_EFFECT_BUFFER_COUNT 71
...
struct TH13Global {
	...
	unsigned int scene_id;		// 0道中、1不明、2不明、3ボス、4中ボス、5不明、6ボス戦終了～次ステージ開始まで
	...
	Unknown2 *unknown14;
	unsigned char unknown15[20];
	unsigned int engine_mode;		// 1通常、2リプレイ、3不明、4プラクティス、5スペルプラクティス
	unsigned char unknown16[48];
	IDirect3D9 *d3d9_ptr;
